...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateCaffeineDisplay() {
        ...
        val recommended = userManager.calculateRecommendedCaffeine(age, isPregnant)
        val todayIntake = userManager.getTodayCaffeineIntake(this)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                withContext(Dispatchers.Main) {
                    if (caffeineAmount > 0) {
                        userManager.addCaffeineIntake(this@MainActivity, caffeineAmount)
                        updateCaffeineDisplay()
